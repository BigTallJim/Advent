...
Wires.prototype.createRoute = function(inputArray){
  ...
  for (var j = 0; j < splitArray.length; j++) {
    ...
    switch (direction){
      case 'U':
          for(var i=0;i<amount;i++){moveArray.push([xPosition,yPosition+=1])}
        break;
      case 'D':
          for(var i=0;i<amount;i++){moveArray.push([xPosition,yPosition-=1])}
        break;
      case 'L':
          for(var i=0;i<amount;i++){moveArray.push([xPosition-=1,yPosition])}
        break;
      case 'R':
        for(var i=0;i<amount;i++){moveArray.push([xPosition+=1,yPosition])}
        break;
...
console.log(2)
var result = wires.findMatches(route1,route2);
console.log(3)
var closest = wires.findClosest(result);
console.log(4)
console.log(closest);
